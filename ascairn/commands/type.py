...
@click.option("--is_single_hap", type=click.Choice(["diploid", "haploid"]), default = "diploid")
...
def type_command(kmer_count_file, output_prefix, kmer_info_file, cluster_kmer_count_file, depth, cluster_haplotype_file, is_single_hap,
